...
TextTheme textTheme() {
  return TextTheme(
    ...
    headline1: TextStyle(fontFamily: Constants.carinoSansFont, fontSize: 70, fontWeight: FontWeight.w600, letterSpacing: -0.5),
    // Main title
    headline2: TextStyle(fontFamily: Constants.carinoSansFont, fontSize: 39, fontWeight: FontWeight.w600, letterSpacing: 0.25),
    //
    headline3: TextStyle(fontFamily: Constants.carinoSansFont, fontSize: 32, fontWeight: FontWeight.w600, letterSpacing: 0.25),
    //
    headline4: TextStyle(fontFamily: Constants.carinoSansFont, fontSize: 30, fontWeight: FontWeight.w600, letterSpacing: 0.25),
    //
